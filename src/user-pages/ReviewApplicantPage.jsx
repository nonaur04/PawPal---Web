          ...
          <div className="mx-auto" style={{ maxWidth: 1100 }}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full flex items-center justify-center text-2xl shrink-0" style={{ backgroundColor: "#FFF3E0" }}>👤</div>
              ...
              <button onClick={() => navigate(`/messages?with=${app.applicantId}&pet=${encodeURIComponent(app.petName)}`)}
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold w-full sm:w-auto shrink-0"
              ...
              <div className="flex-1 min-w-0">
                <div className="rounded-2xl p-5 sm:p-6" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-sm shrink-0" style={{ color: "#9B8778" }}>{questions.length} questions</span>
                  </div>
