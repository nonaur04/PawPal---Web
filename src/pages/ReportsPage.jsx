...
function StrayRow({ report, isOwn }) {
    ...
    <div className="flex items-start gap-4 p-4 rounded-2xl" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          ...
          {report.urgent && (
            <span className="text-xs font-bold px-2 py-0.5 rounded-full flex items-center gap-1" style={{ backgroundColor: "#FEE2E2", color: "#EF4444" }}>
              🚨 URGENT
            </span>
          )}
          {isOwn && (
            <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ backgroundColor: "#F5F2EE", color: "#9B8778" }}>
              You
            </span>
          )}
        </div>
...
function LostCard({ report, isOwn }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "white", border: "1px solid #EEE8E0", width: 320 }}>
      {/* Photo */}
      <div className="relative flex items-center justify-center"
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          <span className="text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1" style={{ backgroundColor: "#FEE2E2", color: "#EF4444" }}>
            😿 LOST
          </span>
          {isOwn && (
            <span className="text-xs font-bold px-2 py-1 rounded-full" style={{ backgroundColor: "#F5F2EE", color: "#9B8778" }}>
              You
            </span>
          )}
        </div>
        {report.reward && (
          <span className="absolute top-3 right-3 text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1" style={{ backgroundColor: "#FFF3E0", color: "#F5A623" }}>
            💰 RM {report.reward}
          </span>
        )}
      </div>
      ...
      <div className="p-4">
        ...
        <button
          ...
          style={isOwn
            ...
            : { border: "1.5px solid #EEE8E0", color: "#6B5E52", backgroundColor: "white" }
          }
        >
        ...
        <main className="flex-1 overflow-y-auto p-6">
            ...
            {tabs.map((tab) => (
              <button
                ...
                style={{
                  ...
                  color: activeTab === tab.key ? "#F5A623" : "#9B8778",
          ...
          {activeTab === "stray" && (
            <div className="max-w-5xl">
              {/* Banner */}
              <div className="flex items-center justify-between px-6 py-4 rounded-2xl mb-6"
                style={{ backgroundColor: "#FFF3E0", border: "1px solid #F5E6CC" }}>
                <div className="flex items-center gap-4">
                  <span className="text-3xl">🚨</span>
                  <div>
                    <p className="font-black text-sm" style={{ color: "#3D2B1F" }}>Spotted a stray?</p>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Report it — the nearest shelter will respond.</p>
                  </div>
                </div>
                <button
                  onClick={() => navigate("/reports/new-stray")}
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h2 className="font-black text-lg" style={{ color: "#3D2B1F" }}>Your Reports</h2>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Strays you've reported</p>
                  </div>
                ...
                {loading ? (
                  <div className="space-y-3">
                    {[1, 2].map((i) => <div key={i} className="rounded-2xl h-20 animate-pulse" style={{ backgroundColor: "white" }} />)}
                  </div>
                ) : myStrayReports.length === 0 ? (
                  <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
                    <p className="text-sm" style={{ color: "#9B8778" }}>You haven't reported any strays yet.</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {myStrayReports.map((r) => <StrayRow key={r.id} report={r} isOwn={true} />)}
                  </div>
                )}
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h2 className="font-black text-lg" style={{ color: "#3D2B1F" }}>All Reports</h2>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Community stray reports nearby</p>
                  </div>
                  <button
                    onClick={() => navigate("/reports/all-strays")}
                    className="text-sm font-bold flex items-center gap-1" style={{ color: "#F5A623" }}>
                    View all ›
                  </button>
                </div>
                {loading ? (
                  <div className="space-y-3">
                    {[1, 2, 3].map((i) => <div key={i} className="rounded-2xl h-20 animate-pulse" style={{ backgroundColor: "white" }} />)}
                  </div>
                ) : allStrayReports.length === 0 ? (
                  <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
                    <p className="text-sm" style={{ color: "#9B8778" }}>No community reports yet.</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {allStrayReports.map((r) => <StrayRow key={r.id} report={r} isOwn={false} />)}
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="max-w-5xl">
              ...
              <div className="flex items-center justify-between px-6 py-4 rounded-2xl mb-6"
                ...
                <div className="flex items-center gap-4">
                  <span className="text-3xl">🔍</span>
                  <div>
                    <p className="font-black text-sm" style={{ color: "#3D2B1F" }}>Lost your pet?</p>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Post a description so the community can help.</p>
                  </div>
                </div>
                <button
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h2 className="font-black text-lg" style={{ color: "#3D2B1F" }}>Your Reports</h2>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Lost pets you've posted</p>
                  </div>
                  <button className="text-sm font-bold flex items-center gap-1" style={{ color: "#F5A623" }}>
                    View all ›
                  </button>
                ...
                {loading ? (
                  <div className="flex gap-4">
                    {[1, 2].map((i) => <div key={i} className="rounded-2xl animate-pulse" style={{ width: 320, height: 340, backgroundColor: "white" }} />)}
                  </div>
                ) : myLostReports.length === 0 ? (
                  <div className="rounded-2xl p-6 text-center max-w-xs" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
                    <p className="text-sm" style={{ color: "#9B8778" }}>You haven't posted any lost pets yet.</p>
                  </div>
                ) : (
                  <div className="flex gap-4 flex-wrap">
                    {myLostReports.map((r) => <LostCard key={r.id} report={r} isOwn={true} />)}
                  </div>
                )}
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div>
                    <h2 className="font-black text-lg" style={{ color: "#3D2B1F" }}>All Reports</h2>
                    <p className="text-xs" style={{ color: "#9B8778" }}>Lost pets posted by the community</p>
                  </div>
                  <button
                    onClick={() => navigate("/reports/all-lost")}
                    className="text-sm font-bold flex items-center gap-1" style={{ color: "#F5A623" }}>
                    View all ›
                  </button>
                </div>
                {loading ? (
                  <div className="flex gap-4">
                    {[1, 2, 3].map((i) => <div key={i} className="rounded-2xl animate-pulse" style={{ width: 320, height: 340, backgroundColor: "white" }} />)}
                  </div>
                ) : allLostReports.length === 0 ? (
                  <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: "white", border: "1px solid #EEE8E0" }}>
                    <p className="text-sm" style={{ color: "#9B8778" }}>No community lost pet posts yet.</p>
                  </div>
                ) : (
                  <div className="flex gap-4 flex-wrap">
                    {allLostReports.map((r) => <LostCard key={r.id} report={r} isOwn={false} />)}
                  </div>
                )}
              </div>
            </div>
